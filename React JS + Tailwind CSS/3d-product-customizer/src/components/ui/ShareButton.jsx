export default function ShareButton() {
  const handleShare = async () => {
    try {
      await navigator.share({
        ...
        text: 'Check out my custom product design!',
        url: window.location.href,
      });
    } catch (error) {
      console.log('Error sharing:', error);
      alert('Copy this URL to share your design: ' + window.location.href);
    }
  };
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-medium mb-3">Share Your Design</h3>
      
      <p className="text-sm text-gray-600 mb-4">
        Share your custom product with friends and family
      </p>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        ...
        <div className="flex space-x-3">
          ...
          <button className="w-10 h-10 rounded-full bg-[#E4405F] text-white flex items-center justify-center hover:opacity-90 transition-opacity">
